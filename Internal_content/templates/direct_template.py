...
def random_instructions():
    ...
    # generate an assembly loop of 50 iteration, inside the loop generate 3 times the following: one ADC instruciton and 2 instructions from steering class mx
    ...
    # generate an assembly ADD instruction that will add two registers and store the result in a register
    ...
    # generate a memory operand and access it. 
    ...
    # generate a random instruction that uses the register as its destination 
