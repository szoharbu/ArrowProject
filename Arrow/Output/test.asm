...
exception_table_core_0_el3_root_1347:
     ...
     ldr x6, =0x0 // Load the address of the trickbox tube                                                           // ( From exception_management/__init__.py, line 147)
     ...
     ldr x14, =0x0 // Load the address of the trickbox tube                                                          // ( From exception_management/__init__.py, line 147)
     ...
     ldr x9, =0x0 // Load the address of the trickbox tube                                                           // ( From test_stage/test_final.py, line 25)
     ...
     ldr x16, =0x0 // Load the address of the trickbox tube                                                          // ( From test_stage/test_final.py, line 25)
...
exception_table_core_0_el1_ns_1348:
     ...
     ldr x2, =0x0 // Load the address of the trickbox tube                                                           // ( From exception_management/__init__.py, line 147)
     ...
     // Close the trickbox tube (end the test)                                                                              // ( From exception_management/__init__.py, line 147)
     ldr x17, =0x0 // Load the address of the trickbox tube                                                          // ( From exception_management/__init__.py, line 147)
